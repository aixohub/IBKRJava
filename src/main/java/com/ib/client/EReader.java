...
/**
 * This class reads commands from TWS and passes them to the user defined EWrapper.
 * <p>
 * This class is initialized with a DataInputStream that is connected to the TWS. Messages begin
 * with an ID and any relevant data are passed afterwards.
 */
public class EReader extends Thread {
  ...
  private EMessage readSingleMessage() throws IOException {
    ...
    System.arraycopy(Arrays.copyOfRange(m_iBuf, msgSize, m_iBuf.length), 0, m_iBuf, 0,
        m_iBuf.length - msgSize);
