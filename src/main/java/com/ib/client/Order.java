...
public class Order {
  ...
  public boolean equals(Object p_other) {
    ...
    if (Util.StringCompare(m_action, l_theOther.m_action) != 0
        ...
        || Util.StringCompare(m_deltaNeutralSettlingFirm, l_theOther.m_deltaNeutralSettlingFirm)
        != 0
        ||
        Util.StringCompare(m_deltaNeutralClearingAccount, l_theOther.m_deltaNeutralClearingAccount)
            != 0
        || Util.StringCompare(m_deltaNeutralClearingIntent, l_theOther.m_deltaNeutralClearingIntent)
        != 0
    ...
    if (!Util.listsEqualUnordered(m_smartComboRoutingParams,
