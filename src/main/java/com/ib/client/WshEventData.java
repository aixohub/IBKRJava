...
public class WshEventData {
  ...
  public boolean fillWatchlist() {
    return m_fillWatchlist;
  }

  public boolean fillPortfolio() {
    return m_fillPortfolio;
  }

  public boolean fillCompetitors() {
    return m_fillCompetitors;
  }
