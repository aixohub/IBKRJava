...
public class Contract implements Cloneable {
  ...
  public Contract(int p_conId, String p_symbol, String p_secType,
      String p_lastTradeDateOrContractMonth,
  ...
  public void description(String v) {
    m_description = v;
  }

  public void issuerId(String v) {
    m_issuerId = v;
  }
  ...
  public boolean equals(Object p_other) {
    ...
    if (p_other == null || !(p_other instanceof Contract l_theOther)) {
      return false;
    }
    ...
    if (!"BOND".equals(m_secType)) {
      ...
      if (Util.StringCompare(m_lastTradeDateOrContractMonth,
          l_theOther.m_lastTradeDateOrContractMonth) != 0 ||
    ...
    return Util.StringCompare(m_issuerId, l_theOther.m_issuerId) == 0;
  }
