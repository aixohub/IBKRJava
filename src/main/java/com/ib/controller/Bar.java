...
public class Bar {
  ...
  private static final ThreadLocal<SimpleDateFormat> FORMAT_CACHE = ThreadLocal.withInitial(
  ...
  public String toString() {
    return String.format("%s %s %s %s %s", m_timeStr != null ? m_timeStr : formattedTime(), m_open,
