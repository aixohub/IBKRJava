...
public class AvailableAlgoParams {
  ...
  //! [scale_params]
  public static void FillScaleParams(Order baseOrder, int scaleInitLevelSize,
      int scaleSubsLevelSize, boolean scaleRandomPercent,
      double scalePriceIncrement, double scalePriceAdjustValue, int scalePriceAdjustInterval,
  ...
  //! [darkice_params]
  public static void FillDarkIceParams(Order baseOrder, int displaySize, String startTime,
      String endTime,
  ...
  //! [pctvol_params]
  public static void FillPctVolParams(Order baseOrder, double pctVol, String startTime,
  ...
  //! [twap_params]
  public static void FillTwapParams(Order baseOrder, String strategyType, String startTime,
      String endTime,
      boolean allowPastEndTime) {
  ...
  public static void FillAccumulateDistributeParams(Order baseOrder, int componentSize,
      int timeBetweenOrders, boolean randomizeTime20, boolean randomizeSize55,
    ...
    baseOrder.algoParams()
        .add(new TagValue("timeBetweenOrders", String.valueOf(timeBetweenOrders)));
  ...
  public static void FillJefferiesVWAPParams(Order baseOrder, String startTime, String endTime,
      ...
      double maxVolumeRate, String excludeAuctions, double triggerPrice, double wowPrice,
  ...
  //! [csfb_inline_params]
  public static void FillCSFBInlineParams(Order baseOrder, String startTime, String endTime,
      String execStyle, int minPercent,
  ...
  public static void FillQBAlgoInlineParams(Order baseOrder, String startTime, String endTime,
      double duration, String benchmark,
