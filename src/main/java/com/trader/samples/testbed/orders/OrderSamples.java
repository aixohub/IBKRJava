...
package com.trader.samples.testbed.orders;
...
public class OrderSamples {
  ...
  public static Order Discretionary(String action, Decimal quantity, double price,
  ...
  public static Order PeggedToStock(String action, Decimal quantity, double delta,
      double stockReferencePrice, double startingPrice) {
    //! [pegged_stock]
    Order order = new Order();
    order.action(action);
  ...
  public static Order AuctionLimit(String action, Decimal quantity, double price,
      int auctionStrategy) {
    //! [auction_limit]
    Order order = new Order();
    order.action(action);
  ...
  public static Order AuctionPeggedToStock(String action, Decimal quantity, double startingPrice,
      double delta) {
  ...
  public static Order LimitOrderWithManualOrderTime(String action, Decimal quantity,
      double limitPrice, String manualOrderTime) {
  ...
  public static Order LimitIfTouched(String action, Decimal quantity, double limitPrice,
      double triggerPrice) {
    // ! [limitiftouched]
    Order order = new Order();
    order.action(action);
  ...
  public static Order PeggedToMidpoint(String action, Decimal quantity, double offset,
      double limitPrice) {
    // ! [pegged_midpoint]
    Order order = new Order();
    order.action(action);
  ...
  //! [bracket]
  public static List<Order> BracketOrder(int parentOrderId, String action, Decimal quantity,
  ...
  public static Order StopLimit(String action, Decimal quantity, double limitPrice,
      double stopPrice) {
    // ! [stoplimit]
    Order order = new Order();
    order.action(action);
  ...
  public static Order TrailingStop(String action, Decimal quantity, double trailingPercent,
  ...
  public static Order ComboLimitOrder(String action, Decimal quantity, boolean nonGuaranteed,
      double limitPrice) {
    // ! [combolimit]
    Order order = new Order();
    order.action(action);
  ...
  public static Order LimitOrderForComboWithLegPrices(String action, Decimal quantity,
      boolean nonGuaranteed, double[] legPrices) {
  ...
  public static Order RelativeLimitCombo(String action, Decimal quantity, boolean nonGuaranteed,
      double limitPrice) {
    // ! [relativelimitcombo]
    Order order = new Order();
    order.action(action);
  ...
  public static Order Volatility(String action, Decimal quantity, double volatilityPercent,
      int volatilityType) {
    // ! [volatility]
    Order order = new Order();
    order.action(action);
  ...
  public static Order AttachAdjustableToStop(Order parent, double attachedOrderStopPrice,
      double triggerPrice, double adjustStopPrice) {
    //! [adjustable_stop]
    Order order = new Order();
  ...
  public static Order AttachAdjustableToStopLimit(Order parent, double attachedOrderStopPrice,
      double triggerPrice, double adjustStopPrice, double adjustedStopLimitPrice) {
  ...
  public static Order AttachAdjustableToTrail(Order parent, double attachedOrderStopPrice,
      double triggerPrice, double adjustStopPrice, double adjustedTrailAmount, int trailUnit) {
    //! [adjustable_trail]
    Order order = new Order();
    //Attached order is a conventional STP order
    order.action("BUY".equals(parent.getAction()) ? "SELL" : "BUY");
  ...
  public static PriceCondition PriceCondition(int conId, String exchange, double price,
      boolean isMore, boolean isConjunction) {
    //! [price_condition]
    //Conditions have to be created via the OrderCondition.Create
    PriceCondition priceCondition = (PriceCondition) OrderCondition.create(
        OrderConditionType.Price);
    //When this contract...
  ...
  public static ExecutionCondition ExecutionCondition(String symbol, String secType,
      String exchange, boolean isConjunction) {
    //! [execution_condition]
    ExecutionCondition execCondition = (ExecutionCondition) OrderCondition.create(
        OrderConditionType.Execution);
  ...
  public static MarginCondition MarginCondition(int percent, boolean isMore,
      boolean isConjunction) {
    //! [margin_condition]
    MarginCondition marginCondition = (MarginCondition) OrderCondition.create(
        OrderConditionType.Margin);
  ...
  public static PercentChangeCondition PercentageChangeCondition(double pctChange, int conId,
      String exchange, boolean isMore, boolean isConjunction) {
  ...
  public static VolumeCondition VolumeCondition(int conId, String exchange, boolean isMore,
      int volume, boolean isConjunction) {
    //! [volume_condition]
  ...
  public static Order PegBestUpToMidOrder(String action, Decimal quantity, double limitPrice,
      int minTradeQty,
  ...
  public static Order PegBestOrder(String action, Decimal quantity, double limitPrice,
      int minTradeQty,
  ...
  public static Order PegMidOrder(String action, Decimal quantity, double limitPrice,
      int minTradeQty,
