...
import com.trader.apidemo.util.IConnectionConfiguration;
import com.trader.apidemo.util.IConnectionConfiguration.DefaultConnectionConfiguration;
import com.trader.apidemo.util.NewLookAndFeel;
...
public class ApiDemo implements IConnectionHandler {
  ...
  public void connected() {
    ...
    controller().reqCurrentTime(
        time -> show("Server date/time is " + Formats.fmtDate(time * 1000)));
