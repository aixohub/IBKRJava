...
public class PegBestPegMidPanel extends OnOKPanel {
  ...
  private final JCheckBox m_competeAgainstBestOffsetUpToMid = new JCheckBox(
      "Compete Against Best Offset Up To Mid");
  ...
  public PegBestPegMidPanel(JDialog parentDlg, Order order) {
    ...
    m_competeAgainstBestOffsetUpToMid.setSelected(
        m_order.competeAgainstBestOffset() == Order.COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID);
  ...
  public OrderCondition onOK() {
    ...
    m_order.competeAgainstBestOffset(
        m_competeAgainstBestOffsetUpToMid.isSelected() ? Order.COMPETE_AGAINST_BEST_OFFSET_UP_TO_MID
            : m_competeAgainstBestOffset.getDouble());
    m_order.minCompeteSize(m_minCompeteSize.getInt());
