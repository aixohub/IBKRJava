...
class AccountPositionsMultiPanel extends JPanel {
  ...
  private class PositionsMultiPanel extends JPanel {
    ...
    private class PositionsResultsPanel extends NewTabPanel implements IPositionMultiHandler {
      ...
      @Override
      public void positionMulti(String account, String modelCode, Contract contract, Decimal pos,
          double avgCost) {
  ...
  private class AccountUpdatesMultiPanel extends JPanel {
    ...
    AccountUpdatesMultiPanel() {
      ...
      HtmlButton requestAccountUpdatesMultiButton = new HtmlButton(
    ...
    private class AccountUpdatesResultsPanel extends NewTabPanel implements
        IAccountUpdateMultiHandler {
      ...
      @Override
      public void accountUpdateMulti(String account, String modelCode, String key, String value,
          String currency) {
