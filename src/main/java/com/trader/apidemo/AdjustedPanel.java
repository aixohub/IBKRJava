...
import com.trader.apidemo.TicketDlg.AmntUnit;
...
public class AdjustedPanel extends OnOKPanel {
  ...
  private final TCombo<OrderType> m_adjustedOrderType = new TCombo<>(OrderType.None, OrderType.STP,
  ...
  public AdjustedPanel(JDialog parentDlg, Order order) {
    ...
    m_adjustedTrailingAmountUnit.setSelectedItem(
        AmntUnit.fromInt(m_order.adjustableTrailingUnit()));
