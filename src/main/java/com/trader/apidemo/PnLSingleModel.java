...
public class PnLSingleModel extends AbstractTableModel {
  ...
  public void addRow(Decimal pos, double dailyPnL, double unrealizedPnL, double realizedPnL,
      double value) {
  ...
  static class Row {
    ...
    public Row(Decimal pos, double dailyPnL, double unrealizedPnL, double realizedPnL,
        double value) {
      m_pos = pos;
      m_dailyPnL = dailyPnL;
