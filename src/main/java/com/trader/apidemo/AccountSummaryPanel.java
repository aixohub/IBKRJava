...
public class AccountSummaryPanel extends NewTabPanel {
  ...
  private static class SummaryModel extends AbstractTableModel implements IAccountSummaryHandler {
    ...
    @Override
    public void accountSummary(String account, AccountSummaryTag tag, String value,
        String currency) {
    ...
    String fmtTime(String val) {
      return val == null || val.length() == 0 || val.equals("0") ? null
          : Formats.fmtDate(Long.parseLong(val) * 1000);
    }
  }
