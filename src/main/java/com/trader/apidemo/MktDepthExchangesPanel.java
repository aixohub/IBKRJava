...
public class MktDepthExchangesPanel extends NewTabPanel {
  ...
  private static class DepthMktDataDescriptionRow {
    ...
    void update(String exchange, String secType, String listingExch, String serviceDataType,
        int aggGroup) {
      m_exchange = exchange;
      m_secType = secType;
  ...
  private class MktDepthExchangesModel extends AbstractTableModel implements
      IMktDepthExchangesHandler {
