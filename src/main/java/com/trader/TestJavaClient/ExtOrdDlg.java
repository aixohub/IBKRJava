...
public class ExtOrdDlg extends JDialog {
  ...
  private final JTextField m_duration = new JTextField();
  private final JTextField m_postToAts = new JTextField();
  ...
  private final JCheckBox m_optOutSmartRoutingCheckBox = new JCheckBox("Opting out of SMART routing",
      false);
  ...
  private final JCheckBox m_dontUseAutoPriceForHedge = new JCheckBox("Don't use auto price for hedge",
      false);
  ...
  private final JCheckBox m_notHeld = new JCheckBox("Not held", false);
  private final JCheckBox m_autoCancelParent = new JCheckBox("Auto Cancel Parent", false);
  private final JTextField m_advancedErrorOverride = new JTextField();
  private final JTextField m_manualOrderTime = new JTextField();
  private final JTextField m_manualOrderCancelTime = new JTextField();
  private final JTextField m_minTradeQty = new JTextField();
  private final JTextField m_minCompeteSize = new JTextField();
  private final JTextField m_competeAgainstBestOffset = new JTextField();
  private final JCheckBox m_competeAgainstBestOffsetUpToMid = new JCheckBox(
      "Compete Against Best Offset Up To Mid", false);
  private final JTextField m_midOffsetAtWhole = new JTextField();
  private final JTextField m_midOffsetAtHalf = new JTextField();
  ...
  void onOk() {
    ...
    try {
      ...
      m_order.exemptCode(
          Integer.parseInt(m_exemptCode.getText().length() != 0 ? m_exemptCode.getText() : "-1"));
