...
public class HistoricalDataDlg extends JDialogBox {
  ...
  private final JComboBox m_tickByTickTypeComboBox = new JComboBox(
      new Object[]{"Last", "AllLast", "BidAsk", "MidPoint"});
  ...
  public HistoricalDataDlg(Window parent) {
    ...
    m_panel.addGBComponent(new JLabel("Start Date/Time"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    m_panel.addGBComponent(m_StartTime, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    m_panel.addGBComponent(new JLabel("End Date/Time"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    m_panel.addGBComponent(m_BackfillEndTime, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    m_panel.addGBComponent(new JLabel("Number of ticks"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    ...
    m_panel.addGBComponent(new JLabel("Bar Size Setting (1 to 11)"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    m_panel.addGBComponent(m_BarSizeSetting, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    m_panel.addGBComponent(new JLabel("What to Show"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    m_panel.addGBComponent(m_WhatToShow, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    m_panel.addGBComponent(new JLabel("Regular Trading Hours (1 or 0)"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    m_panel.addGBComponent(m_UseRTH, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    m_panel.addGBComponent(new JLabel("Date Format Style (1 or 2)"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    m_panel.addGBComponent(m_FormatDate, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    m_panel.addGBComponent(new JLabel("Keep up to date"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    ...
    m_panel.addGBComponent(new JLabel("Tick-By-Tick Type"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
