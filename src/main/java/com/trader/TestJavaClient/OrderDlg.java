...
import com.trader.apidemo.AdjustedPanel;
import com.trader.apidemo.ConditionsPanel;
import com.trader.apidemo.OnOKPanel;
import com.trader.apidemo.PegBenchPanel;
import com.trader.apidemo.util.TCombo;
...
public class OrderDlg extends JDialog {
  ...
  private final JTextField m_symbol = new JTextField("SPY");
  ...
  private final JTextField m_primaryExch = new JTextField("ARCA");
  ...
  private final JTextField m_issuerId = new JTextField();
  ...
  OrderDlg(SampleFrame owner) {
    ...
    pContractDetails.addGBComponent(new JLabel("Contract Id"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_conId, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Symbol"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_symbol, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Security Type"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_secType, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Last trade date or contract month"), gbc,
        COL1_WIDTH, GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_lastTradeDateOrContractMonth, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Strike"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_strike, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Put/Call"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_right, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Option Multiplier"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_multiplier, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Exchange"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_exchange, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Primary Exchange"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_primaryExch, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Currency"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_currency, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Local Symbol"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_localSymbol, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Trading Class"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_tradingClass, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Include Expired"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_includeExpired, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Sec Id Type"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_secIdType, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Sec Id"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pContractDetails.addGBComponent(m_secId, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pContractDetails.addGBComponent(new JLabel("Issuer Id"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    ...
    pOrderDetails.addGBComponent(new JLabel("Action"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_action, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Total Order Size"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_totalQuantity, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Order Type"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_orderType, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Lmt Price / Option Price / Stop Price / Volatility"),
        gbc, COL1_WIDTH, GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_lmtPrice, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Aux Price / Underlying Price"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_auxPrice, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Good After Time"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_goodAfterTime, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Good Till Date"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_goodTillDate, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Cash Quantity"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOrderDetails.addGBComponent(m_cashQty, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    pOrderDetails.addGBComponent(new JLabel("Use Price Management Algo"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    ...
    pMarketDepth.addGBComponent(new JLabel("Number of Rows"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pMarketDepth.addGBComponent(m_marketDepthRowTextField, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    ...
    pMarketData.addGBComponent(new JLabel("Generic Tick Tags"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pMarketData.addGBComponent(m_genericTicksTextField, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    pMarketData.addGBComponent(m_snapshotMktDataTextField, gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pMarketData.addGBComponent(m_regSnapshotMktDataTextField, gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    ...
    pOptionsExercise.addGBComponent(new JLabel("Action (1 or 2)"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOptionsExercise.addGBComponent(m_exerciseActionTextField, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    pOptionsExercise.addGBComponent(new JLabel("Number of Contracts"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOptionsExercise.addGBComponent(m_exerciseQuantityTextField, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    pOptionsExercise.addGBComponent(new JLabel("Override (0 or 1)"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pOptionsExercise.addGBComponent(m_overrideTextField, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
    ...
    pMarketDataType.addGBComponent(new JLabel("Market Data Type"), gbc, COL1_WIDTH,
        GridBagConstraints.RELATIVE);
    pMarketDataType.addGBComponent(m_marketDataTypeCombo, gbc, COL2_WIDTH,
        GridBagConstraints.REMAINDER);
  ...
  void onBtnDeltaNeutralContract() {
    DeltaNeutralContractDlg deltaNeutralContractDlg = new DeltaNeutralContractDlg(
        m_deltaNeutralContract, this);
  ...
  void onBtnSmartComboRoutingParams() {
    SmartComboRoutingParamsDlg smartComboRoutingParamsDlg = new SmartComboRoutingParamsDlg(
        "Smart Combo Routing Params", m_order.smartComboRoutingParams(), this);
  ...
  void onBtnOptions() {
    SmartComboRoutingParamsDlg smartComboRoutingParamsDlg = new SmartComboRoutingParamsDlg(
        m_optionsDlgTitle, m_options, this);
