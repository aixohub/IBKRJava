...
public class GroupsDlg extends JDialog {
  ...
  void onSubscribeToGroupEvents() {
    ...
    try {
      ...
      m_txtGroupMessages.add(
          "Subscribing to group events reqId=" + reqId + " groupId=" + groupId + " ...");
  ...
  void onUpdateDisplayGroup() {
    ...
    try {
      ...
      if (!contractInfo.isEmpty()) {
        m_txtGroupMessages.add(
            "Updating display group reqId=" + reqId + " contractInfo=" + contractInfo + " ...");
  ...
  void displayGroupUpdated(int reqId, String contractInfo) {
    m_txtGroupMessages.add(
        "Display group updated: reqId=" + reqId + " contractInfo=" + contractInfo);
  }
