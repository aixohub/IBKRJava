...
class PortfolioTable extends AbstractTableModel {
  ...
  void updatePortfolio(Contract contract, Decimal position, double marketPrice, double marketValue,
    ...
    PortfolioTableRow newData =
        new PortfolioTableRow(contract, position, marketPrice, marketValue, averageCost,
  ...
  static class PortfolioTableRow {
    ...
    Object getValue(int c) {
      switch (c) {
        ...
        case 4:
          return m_contract.lastTradeDateOrContractMonth() == null ? null
              : Util.DoubleMaxString(m_contract.strike());
        case 5:
          return (m_contract.getRight() != null && m_contract.getRight().equals("???")) ? null
              : m_contract.getRight();
        case 6:
