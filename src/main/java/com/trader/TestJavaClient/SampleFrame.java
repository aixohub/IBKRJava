...
class SampleFrame extends JFrame implements EWrapper {
  ...
  private final SmartComponentsParamsReqDlg m_smartComponentsParamsReq = new SmartComponentsParamsReqDlg(
      this);
  ...
  private final WSHDlg m_wshMetaDlg = new WSHDlg(this, false);
  private final WSHDlg m_wshEventDlg = new WSHDlg(this, true);
  ...
  private JPanel createButtonPanel() {
    ...
    butCancelCalculateImpliedVolatility.addActionListener(
        e -> onCancelCalculateImpliedVolatility());
    ...
    butRequestSecurityDefinitionOptionParameters.addActionListener(
        e -> onRequestSecurityDefinitionOptionParameters());
  ...
  private void onReqTickByTickData() {
    ...
    if (m_orderDlg.m_rc) {
      m_client.reqTickByTickData(m_orderDlg.id(), m_orderDlg.contract(),
          m_orderDlg.tickByTickType(), m_orderDlg.numberOfTicks(),
  ...
  private void onReqHistoricalTicks() {
    ...
    if (m_orderDlg.m_rc) {
      m_client.reqHistoricalTicks(m_orderDlg.id(), m_orderDlg.contract(),
          m_orderDlg.startDateTime(),
  ...
  private void onReqPnLSingle() {
    ...
    m_client.reqPnLSingle(m_pnlSingleDlg.m_reqId, m_pnlSingleDlg.m_account,
        m_pnlSingleDlg.m_modelCode,
  ...
  private void onHistogram() {
    ...
    m_client.reqHistogramData(m_orderDlg.id(), m_orderDlg.contract(), m_orderDlg.useRTH() == 1,
        m_orderDlg.backfillDuration());
  }
  ...
  private void onRequestSecurityDefinitionOptionParameters() {
    ...
    if (m_secDefOptParamsReq.isOK()) {
      m_client.reqSecDefOptParams(m_secDefOptParamsReq.id(), underlyingSymbol,
          futFopExchange,/* currency,*/ underlyingSecType, underlyingConId);
    }
  }
  ...
  private void onReqMktData() {
    ...
    m_client.reqMktData(m_orderDlg.id(), m_orderDlg.contract(),
        m_orderDlg.m_genericTicks, m_orderDlg.m_snapshotMktData, m_orderDlg.m_reqSnapshotMktData,
        m_mktDataOptions);
  }
  ...
  private void onScanner() {
    ...
    if (m_scannerDlg.m_userSelection == ScannerDlg.CANCEL_SELECTION) {
      ...
      m_client.reqScannerSubscription(m_scannerDlg.m_id,
          ...
          m_scannerDlg.scannerFilterOptions());
  ...
  private void onReqMktDepth() {
    ...
    if (depthDialog == null) {
      depthDialog = new MktDepthDlg(
          (isSmartDepth ? "SMART" : "Market") + " Depth ID [" + dialogId + "]", this, isSmartDepth);
      if (isSmartDepth) {
    ...
    // req mkt data
    m_client.reqMktDepth(dialogId, m_orderDlg.contract(), m_orderDlg.m_marketDepthRows,
        isSmartDepth, m_mktDepthOptions);
  ...
  private void placeOrder(boolean whatIf) {
    // run m_orderDlg
    m_orderDlg.init("Order Misc Options", true, "Order Misc Options",
        m_orderDlg.m_order.orderMiscOptions());
    ...
    if (m_client.isConnected()) {
      switch (m_orderDlg.m_marketDataType) {
        ...
        case MarketDataType.DELAYED:
          m_TWS.add(
              "Delayed market data type is enabled, Delayed-Frozen market data type is disabled");
          break;
  ...
  private void onRequestAccountUpdatesMulti() {
    ...
    if (dlg.m_rc) {
      ...
      m_client.reqAccountUpdatesMulti(dlg.m_retId, dlg.m_retAccount, dlg.m_retModelCode,
          dlg.m_retLedgerAndNLV);
    }
  }
  ...
  public void tickOptionComputation(int tickerId, int field, int tickAttrib, double impliedVol,
    ...
    String msg = EWrapperMsgGenerator.tickOptionComputation(tickerId, field, tickAttrib, impliedVol,
  ...
  public void historicalData(int reqId, Bar bar) {
    String msg = EWrapperMsgGenerator.historicalData(reqId, bar.time(), bar.open(), bar.high(),
  ...
  public void realtimeBar(int reqId, long time, double open, double high, double low, double close,
    ...
    String msg = EWrapperMsgGenerator.realtimeBar(reqId, time, open, high, low, close, volume, wap,
        count);
    m_tickers.add(msg);
  }
  ...
  public void positionMulti(int reqId, String account, String modelCode, Contract contract,
    ...
    String msg = EWrapperMsgGenerator.positionMulti(reqId, account, modelCode, contract, pos,
        avgCost);
    m_TWS.add(msg);
  }
  ...
  public void accountUpdateMulti(int reqId, String account, String modelCode, String key,
    ...
    String msg = EWrapperMsgGenerator.accountUpdateMulti(reqId, account, modelCode, key, value,
        currency);
    m_TWS.add(msg);
  }
  ...
  public void securityDefinitionOptionalParameter(int reqId, String exchange, int underlyingConId,
    ...
    String msg = EWrapperMsgGenerator.securityDefinitionOptionalParameter(reqId, exchange,
  ...
  public void tickNews(int tickerId, long timeStamp, String providerCode, String articleId,
    ...
    String msg = EWrapperMsgGenerator.tickNews(tickerId, timeStamp, providerCode, articleId,
        headline, extraData);
    m_TWS.add(msg);
  }
  ...
  public void tickReqParams(int tickerId, double minTick, String bboExchange,
    ...
    String msg = EWrapperMsgGenerator.tickReqParams(tickerId, minTick, bboExchange,
        snapshotPermissions);
  ...
  public void historicalNews(int requestId, String time, String providerCode, String articleId,
      String headline) {
    String msg = EWrapperMsgGenerator.historicalNews(requestId, time, providerCode, articleId,
        headline);
    m_TWS.add(msg);
  }
  ...
  public void pnlSingle(int reqId, Decimal pos, double dailyPnL, double unrealizedPnL,
    ...
    String msg = EWrapperMsgGenerator.pnlSingle(reqId, pos, dailyPnL, unrealizedPnL, realizedPnL,
        value);
  ...
  public void historicalTicksLast(int reqId, List<HistoricalTickLast> ticks, boolean done) {
    ...
    for (HistoricalTickLast tick : ticks) {
      msg.append(EWrapperMsgGenerator.historicalTickLast(reqId, tick.time(), tick.tickAttribLast(),
  ...
  public void tickByTickAllLast(int reqId, int tickType, long time, double price, Decimal size,
    ...
    String msg = EWrapperMsgGenerator.tickByTickAllLast(reqId, tickType, time, price, size,
  ...
  public void tickByTickBidAsk(int reqId, long time, double bidPrice, double askPrice,
    ...
    String msg = EWrapperMsgGenerator.tickByTickBidAsk(reqId, time, bidPrice, askPrice, bidSize,
  ...
  public void historicalSchedule(int reqId, String startDateTime, String endDateTime,
    ...
    String msg = EWrapperMsgGenerator.historicalSchedule(reqId, startDateTime, endDateTime,
        timeZone, sessions);
    m_TWS.add(msg);
  }
