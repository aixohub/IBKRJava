...
public class ComboLegDlg extends JDialog {
  ...
  ComboLegDlg(List<ComboLeg> comboLegs, List<OrderComboLeg> orderComboLegs, String orderExchange,
      JDialog owner) {
    super(owner, true);
  ...
  void onAddLeg() {
    try {
      ...
      int exemptCode = Integer.parseInt(
          m_exemptCode.getText().length() != 0 ? m_exemptCode.getText() : "-1");
